                ...
                let cardHtml = `
                    <div class="col-md-4 col-lg-12">
                        <div class="blog-card blog-card-blog">
                            <div class="blog-card-image"><a href="noticia.html"><img class="img" src="assets/img/noticias/${noticia.imagen}" width="180" height="270"></a>
                                <div class="ripple-cont"></div>
                            </div>
                            <div class="blog-table">
                                <h6 class="blog-category blog-text-success"><i class="far fa-newspaper"></i> Noticia</h6>
                                <h4 class="blog-card-caption"><a href="noticia.html">${noticia.titulo}</a></h4>
                                <!-- <p class="blog-card-description">${noticia.subtitulo}</p> -->
                                <div class="ftr">
                                    <div class="author">
                                        <a href="noticia.html"><span>Ir a la noticia</span>
